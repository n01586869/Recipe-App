...
const Breakfast = ({ route, navigation }) => {
  ...
  useEffect(() => {
    fetch(`${API}/${API_KEY}/filter.php?c=Breakfast`) // get list of Breakfasts. this returns array of objects with only meal id and thumbnail
  ...
  return(
    <Stack.Navigator screenOptions={{
      ...
      <Stack.Screen name="Breakfast Screen" component={BreakfastScreen}/>
